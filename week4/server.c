    ...
    while (1) {
        ...
        if (FD_ISSET(master_sock_tcp_fd, &readfds)) {
            ...
            while (1) {
                ...
                struct Student *client_data = (struct Student *) data_buffer;//test_struct_t *client_data = (test_struct_t *) data_buffer;
                ...
                strcpy(student.name, client_data->name);
                student.age = client_data->age;
                student.group = client_data->group;

                /* Server replying back to client now*/
                sent_recv_bytes = sendto(comm_socket_fd, (char *) &student, sizeof(student), 0,
